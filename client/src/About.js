  ...
  render() {
    return (
      <div>
        ...
        person I do plan on furthering my education after I gain some years of experience after graduation. I'm currently seeking an intership or job before graduation so I'd love to hear of possible oppurtunities
        for me to pursue.
        </p>
        </div>
